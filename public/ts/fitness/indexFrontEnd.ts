...
const edit_fitplan_btn: HTMLButtonElement =
  document.querySelector("#edit_fitplan_btn")!;

const create_fitplan_btn: HTMLButtonElement = document.querySelector(
  "#create_fitplan_btn"
)!;
const show_fitplan_btn: HTMLButtonElement =
  document.querySelector("#show_fitplan_btn")!;

const create_fitplan_template: HTMLTemplateElement = document.querySelector(
  "#create_fitplan_template"
)!;

const show_plan_template: HTMLTemplateElement = document.querySelector(
  "#show_plan_template"
)!;
...
if (create_fitplan_btn && show_fitplan_btn) {
  create_fitplan_btn.addEventListener("click", () => {
    setDisplayElement(
      [create_fitplan_btn, show_fitplan_btn, edit_fitplan_btn],
      "none"
    );
    ...
    const create_fitplan_form: HTMLFormElement = document.querySelector(
      "#create_fitplan_form"
    )!;
    if (create_fitplan_form) {
      create_fitplan_form.addEventListener("submit", async (event) => {
        ...
        const title: string = create_fitplan_form.planTitle.value;
        const days: number = +create_fitplan_form.days.value;
        ...
        if (data.errors) {
          const error_expense_message: HTMLDivElement | null =
            document.querySelector("div.alert.alert-danger.error-submit");
