...
const entertainment_balance_table = document.querySelector("#entertainment_balance_table");
const eatout_balance_table = document.querySelector("#eatout_balance_table");
            ...
            if (amount <= 0) {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        const all_inputs_expenses = document.querySelectorAll("#new_expense_form_expenses input");
